...
const navigation = {
  about: [
    { name: 'Order Food', to: '/' },
    { name: 'Track Order', to: '/OrderDetails' },
    { name: 'Partners Kitchens', to: '#' },
    { name: 'Help Center', to: '#' }
  ],
  menu: [
    { name: 'Soups', href: '#' },
            ...
            <div className="md:grid md:grid-cols-1 lg:grid-cols-2 md:gap-8 lg:pl-10">
              ...
              <div className="mt-12 md:mt-0">
                ...
                <ul role="list" className="mt-4 space-y-4 text-gray-300">
                  ...
                  <li>Headquaters, Lagos, Nigeria</li>
                </ul>
              </div>
              </div>
            </div>
            <div className="md:grid md:grid-cols-1 md:gap-8 xl:pl-20">
              <h3 className="text-sm font-semibold text-gray-400 tracking-wider uppercase mb-0 ">Download App</h3>
              <div className="flex space-x-6 ">
              {navigation.social.map((item) => (
                <a key={item.name} href={item.href} className="text-gray-300 hover:text-tertiary pt-10 xl:pt-0">
                  <span className="sr-only">{item.name}</span>
                  <item.icon className="h-6 w-6" aria-hidden="true" />
                </a>
              ))}
